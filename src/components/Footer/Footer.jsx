...
const Footer = () => {
    return (
        <div>
            <footer className="footer items-center font-serif p-4 bg-gradient-to-r from-blue-200 to-red-200 text-neutral-content">
                <div className="items-center grid-flow-col text-black">
                    ...
                    <p>DishDetective || Sanad Bhowmik | 2023</p>
                </div>
